...
* 🐛 **Report Bugs:** Find something broken? Open a [Bug Report](https://github.com/Qaidsaher/taj-al-waqar/issues/new/choose) and help us squash it!
* ✨ **Suggest Features:** Have a brilliant idea? We're all ears! Share it as a [Feature Request](https://github.com/Qaidsaher/taj-al-waqar/issues/new/choose).
...
* **Clone** your fork to your local machine:
    ```bash
    git clone https://github.com/YOUR_USERNAME/taj-al-waqar.git
    cd taj-al-waqar
    ```
...
- Check the [Discussions](https://github.com/Qaidsaher/taj-al-waqar/discussions) for help or to ask questions.
