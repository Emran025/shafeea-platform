            ...
            <section className="relative py-24 bg-gradient-primary overflow-hidden animate-fade-in-up">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center">
                        ...
                        <Badge className="mb-6 bg-white/20 text-white border-white/30 hover:bg-white/30 glass-card hover-lift transition-all duration-300 text-sm px-4 py-2">
                        ...
                        <div className="max-w-lg mx-auto">
                            <div className="relative group">
                                <div className="absolute inset-0 bg-white/10 rounded-2xl blur-sm group-hover:blur-md transition-all duration-300"></div>
                                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl p-2">
                                    ...
                                    <Input
                                        ...
                                        className="pl-4 pr-12 py-4 bg-transparent border-0 text-white placeholder-white/70 text-lg focus:ring-2 focus:ring-white/30 rounded-xl"
                                    />
                                </div>
                            </div>
                        </div>
