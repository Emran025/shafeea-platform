                            ...
                            <div className="lg:col-span-2">
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="bg-white p-2.5 rounded-xl shadow-xl shadow-blue-900/30 border border-white/10">
                                        <img src="/logo-optimized.webp" alt="Shafeea" className="w-10 h-10 object-contain" />
                                    </div>
                                    <div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-sm text-gray-400 hover:text-white transition-colors cursor-pointer">info@shafeea.systems360.cloud</span>
                                    </li>
                                    <li className="flex items-start gap-3">
