...
export default function MediaBlock({ block }: Props) {
    ...
    const fieldsSrc = getTextField(block, 'image_url') || getTextField(block, 'url') || getTextField(block, 'src');
    const altText   = getTextField(block, 'alt') || getTextField(block, 'alt_text') || getTextField(block, 'title');
