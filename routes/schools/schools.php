...
use App\Http\Controllers\Public\PageController as SchoolAdminPageController;
...
Route::group(['prefix' => 'school/{school_code}', 'as' => 'school.template.'], function() {
    ...
    // Main template views & pages
    Route::get('/', [SchoolTemplateController::class, 'index'])->name('index');
    Route::get('/page/{page?}', [SchoolTemplateController::class, 'show'])->name('show');
