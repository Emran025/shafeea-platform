...
class PlanFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'review_unit_id' => $hasReview ? \App\Models\Tracking\Unit::factory() : null,
            'review_amount' => fake()->numberBetween(1, 50),
            'has_memorization' => $hasMemorization,
            'memorization_unit_id' => $hasMemorization ? \App\Models\Tracking\Unit::factory() : null,
            'memorization_amount' => fake()->numberBetween(1, 50),
            'has_sard' => $hasSard,
            'sard_unit_id' => $hasSard ? \App\Models\Tracking\Unit::factory() : null,
            'sard_amount' => fake()->numberBetween(1, 50),
            'frequency_type_id' => \App\Models\Tracking\FrequencyType::factory(),
        ];
    }
}
