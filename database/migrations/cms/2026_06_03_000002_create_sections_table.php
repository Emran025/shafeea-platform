...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('sections', function (Blueprint $table) {
            ...
            // Internal governance field — never exposed in rendering contract
            ...
            // VisibilityPolicy
            // Stores AudienceType[] — e.g. ["public"] | ["authenticated"] | ["admin_preview"]
            ...
            // AuditRecord
            // FK constraint to users deferred until users is migrated to UUID PKs
