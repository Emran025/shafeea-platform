...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('pages', function (Blueprint $table) {
            ...
            // PageHierarchy
            // Self-referential FK — constrained below after table creation
            ...
            // Stores a MediaReference JSON object { media_id, alt }
            // FK to media table will be added in a later migration (see media migration)
            ...
            // AuditRecord
            // created_by / last_modified_by / published_by are UUID references to users.
            // FK constraint to users.id is deferred until users is migrated to UUID PKs.
