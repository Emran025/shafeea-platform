...
class PrivacyPolicySeeder extends Seeder
{
    ...
    {
        $summary = [
            'توضح سياسة الخصوصية هذه بالتفصيل كيفية جمع واستخدام وحماية معلوماتك الشخصية عند استخدامك لمنصتنا التعليمية.',
            'نحن ملتزمون التزاماً كاملاً بحماية خصوصيتك وضمان أمان بياناتك بما يتوافق مع أفضل الممارسات والمعايير التنظيمية.',
        ...
        $sections = [
            [
                'title' => 'مقدمة',
                'content' => 'أهلاً بك في سياسة الخصوصية لمنصتنا. تهدف هذه الوثيقة إلى توفير معلومات شفافة ومفصلة حول البيانات التي نجمعها، الأساس القانوني لجمعها، كيفية استخدامنا لها، ومع من نشاركها. خصوصيتك هي أولويتنا القصوى، ونحن نشجعك على قراءة هذه السياسة بعناية لفهم حقوقك وممارساتنا.'
            ],
            [
                'title' => 'المعلومات التي نجمعها',
                'content' => 'نقوم بجمع أنواع مختلفة من المعلومات لتوفير وتحسين خدماتنا لك بشكل فعال. قد يشمل ذلك:
...
- ملفات تعريف الارتباط (Cookies) لتحسين تجربتك وتخصيص المحتوى.'
            ...
            [
                ...
                'content' => 'تُستخدم المعلومات التي نجمعها للأغراض التالية:
...
- الامتثال للالتزامات القانونية والتنظيمية.'
            ...
            [
                ...
                'content' => 'نقوم بمعالجة بياناتك الشخصية بناءً على الأسس القانونية التالية:
...
- المصلحة المشروعة: عندما تكون المعالجة ضرورية لمصالحنا المشروعة، شريطة ألا تتجاوز مصالحك وحقوقك الأساسية.'
            ...
            [
                ...
                'content' => 'نحن لا نبيع أو نؤجر بياناتك الشخصية لأطراف ثالثة. قد نشارك معلوماتك في الحالات التالية:
...
- في حالة اندماج أو استحواذ أو بيع أصول الشركة، مع ضمان حماية بياناتك.'
            ...
            [
                'title' => 'أمن البيانات',
                'content' => 'نحن نطبق تدابير أمنية تقنية وتنظيمية متقدمة لحماية بياناتك من الوصول غير المصرح به، التغيير، الكشف، أو الإتلاف. تشمل هذه التدابير تشفير البيانات، التحكم في الوصول، ومراجعات أمنية منتظمة. ومع ذلك، لا توجد طريقة نقل عبر الإنترنت أو تخزين إلكتروني آمنة بنسبة 100%، ولكننا نسعى جاهدين لاستخدام وسائل مقبولة تجاريًا لحماية معلوماتك.'
            ],
            [
                'title' => 'حقوق المستخدم',
                'content' => 'لديك حقوق معينة فيما يتعلق ببياناتك الشخصية، وتشمل:
...
يمكنك ممارسة هذه الحقوق من خلال إعدادات حسابك أو عن طريق الاتصال بنا مباشرة.'
            ...
            [
                ...
                'content' => 'نحتفظ ببياناتك الشخصية طالما كان ذلك ضرورياً لتحقيق الأغراض التي تم جمعها من أجلها، بما في ذلك لأغراض تلبية أي متطلبات قانونية أو محاسبية أو إعداد تقارير. سيتم تحديد فترة الاحتفاظ بناءً على كمية وطبيعة وحساسية البيانات.'
            ],
            [
                'title' => 'خصوصية الأطفال',
                'content' => 'تم تصميم منصتنا للمستخدمين الذين تزيد أعمارهم عن 13 عامًا. نحن لا نجمع عن قصد معلومات شخصية من الأطفال دون سن 13 عامًا. إذا علمنا أننا جمعنا بيانات شخصية من طفل دون موافقة الوالدين، فسنتخذ خطوات لحذف تلك المعلومات في أقرب وقت ممكن.'
            ],
            [
                'title' => 'روابط الطرف الثالث',
                'content' => 'قد تحتوي خدمتنا على روابط لمواقع أخرى لا يتم تشغيلها من قبلنا. إذا قمت بالنقر فوق ارتباط جهة خارجية، فسيتم توجيهك إلى موقع تلك الجهة الخارجية. ننصحك بشدة بمراجعة سياسة الخصوصية لكل موقع تزوره. ليس لدينا أي سيطرة ولا نتحمل أي مسؤولية عن المحتوى أو سياسات الخصوصية أو الممارسات الخاصة بأي مواقع أو خدمات خاصة بطرف ثالث.'
            ],
            [
                'title' => 'التغييرات على سياسة الخصوصية',
                'content' => 'قد نقوم بتحديث سياسة الخصوصية الخاصة بنا من وقت لآخر. سنقوم بإعلامك بأي تغييرات عن طريق نشر السياسة الجديدة على هذه الصفحة وتحديث تاريخ "آخر تحديث". يُنصح بمراجعة هذه السياسة بشكل دوري للاطلاع على أي تغييرات. استمرار استخدامك للخدمة بعد نشر التغييرات يعتبر قبولاً لها.'
            ],
            [
                'title' => 'الاتصال بنا',
                'content' => 'إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه، يمكنك الاتصال بنا عبر البريد الإلكتروني: privacy@example.com أو من خلال صفحة الاتصال على موقعنا.'
            ]
        ];
