...
class DatabaseSeeder extends Seeder
{
    ...
    function seedSystemData(): void
    {
        ...
        foreach (range(1, 10) as $i) {
            $user = \App\Models\User::create([
                ...
                'email' => "teacherhad$i@example.com",
    ...
    public function seedAllFromLists(): void
    {
        // ✅ قائمة المدارس
        $schoolNames = [
            'الفتح',
        ...
        // ✅ قائمة الطلاب
        $studentList = collect([
            ['name' => 'أحمد سعيد', 'email' => 'ahmad1@example.com'],
            ['name' => 'عبد الله منصور', 'email' => 'abdullah2@example.com'],
            ['name' => 'محمد يحيى', 'email' => 'mohammad3@example.com'],
            ['name' => 'خالد زيد', 'email' => 'khalid4@example.com'],
            ['name' => 'طارق حسين', 'email' => 'tareq5@example.com'],
            ['name' => 'سالم قاسم', 'email' => 'salem6@example.com'],
            ['name' => 'يوسف علي', 'email' => 'yousef7@example.com'],
            ['name' => 'جمال أحمد', 'email' => 'jamal8@example.com'],
            ['name' => 'ياسين محمد', 'email' => 'yaseen9@example.com'],
            ['name' => 'أنس عبد الله', 'email' => 'anas10@example.com'],
            ['name' => 'إبراهيم ناصر', 'email' => 'ibrahim11@example.com'],
            ['name' => 'صالح عبد الرحمن', 'email' => 'saleh12@example.com'],
            ['name' => 'نبيل عبد الكريم', 'email' => 'nabil13@example.com'],
            ['name' => 'عمار عبد الله', 'email' => 'ammar14@example.com'],
            ['name' => 'زكريا علي', 'email' => 'zakaria15@example.com'],
            ['name' => 'مازن فؤاد', 'email' => 'mazen16@example.com'],
            ['name' => 'سفيان أحمد', 'email' => 'sofyan17@example.com'],
            ['name' => 'وسيم حسن', 'email' => 'waseem18@example.com'],
            ['name' => 'حسين غالب', 'email' => 'hussain19@example.com'],
            ['name' => 'رامي عبد الباري', 'email' => 'rami20@example.com'],
        ]);
