...
This document provides a comprehensive overview of the database schema, migrations, Eloquent models, and their relationships for the Shafeea project.
...
_No Eloquent model shown, but used for Laravel Sanctum authentication._
...
_No Eloquent model shown, used for Laravel Telescope debugging/monitoring._
...
_No Eloquent model shown, used for Laravel cache system._
...
_No Eloquent model shown, used for Laravel queue system._
...
_For more details, see the respective migration and model files._
